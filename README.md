...
| | Application List Type | `Allow`: The cursor will auto-show inside selected applications and auto-hide otherwise.<br />`Deny`: The cursor will auto-hide inside selected applications and auto-show otherwise.                                                                                                                                                                                                                                                                                                                                                                                                                  |
| | Select Applications | Enables auto-hide/show on any application in the app drawer plus the stock launcher.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| | Allow Passthrough | `On`: Cursor will process but not intercept key presses. Not recommended.<br />`Off`: Cursor will both process and intercept key presses. Default behavior.                                                                                                                                                                                                                                                                                                                                                                                                                                            |
